...
void execute_call(int call)
{
  ...
  case 0:
    ...
    //    flags: open_flags = 0x20001 (8 bytes)
    //  ]
    //  returns fd_dri
  ...
  case 1:
    ...
    //        height: int32 = 0x2 (4 bytes)
    //        width: int32 = 0x8 (4 bytes)
    //        bpp: int32 = 0x9 (4 bytes)
    ...
    *(uint32_t*)0x200000000184 = 8;
    *(uint32_t*)0x200000000188 = 9;
    *(uint32_t*)0x20000000018c = 0;
    res = syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc02064b2,
                  /*arg=*/0x200000000180ul);
    if (res != -1)
      r[1] = *(uint32_t*)0x200000000190;
    break;
  case 2:
    //  ioctl$DRM_IOCTL_MODE_MAP_DUMB arguments: [
    //    fd: fd_dri (resource)
    //    cmd: const = 0xc01064d2 (4 bytes)
    //    arg: ptr[inout, drm_mode_map_dumb] {
    //      drm_mode_map_dumb {
    //        handle: drm_dumb_handle (resource)
    //        pad: const = 0x3f00 (4 bytes)
    //        offset: int64 = 0x0 (8 bytes)
    //      }
    //    }
    //  ]
    *(uint32_t*)0x200000000140 = r[1];
    *(uint32_t*)0x200000000144 = 0x3f00;
    syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc01064d2,
            /*arg=*/0x200000000140ul);
    break;
  case 3:
    //  ioctl$DRM_IOCTL_MODE_DESTROY_DUMB arguments: [
    //    fd: fd_dri (resource)
    //    cmd: const = 0xc00464b4 (4 bytes)
    //    arg: ptr[in, drm_mode_destroy_dumb] {
    //      drm_mode_destroy_dumb {
    //        handle: drm_dumb_handle (resource)
    //      }
    //    }
    //  ]
    *(uint32_t*)0x200000000080 = r[1];
    syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc00464b4,
