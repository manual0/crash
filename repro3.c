...
void execute_call(int call)
{
  ...
  case 0:
    ...
    //    }
    //    id: intptr = 0x3fffc0 (8 bytes)
    //    flags: open_flags = 0x2a500 (8 bytes)
    //  ]
    //  returns fd_dri
    memcpy((void*)0x200000000000, "/dev/dri/card#\000", 15);
    res = -1;
    res = syz_open_dev(
        /*dev=*/0x200000000000, /*id=*/0x3fffc0,
        /*flags=O_NOFOLLOW|O_NOCTTY|O_LARGEFILE|FASYNC|O_APPEND*/ 0x2a500);
    if (res != -1)
      r[0] = res;
    break;
  case 1:
    ...
    //        height: int32 = 0x8 (4 bytes)
    //        width: int32 = 0x4 (4 bytes)
    //        bpp: int32 = 0x10000 (4 bytes)
    ...
    *(uint32_t*)0x200000000088 = 0x10000;
  ...
  case 2:
    //  ioctl$DRM_IOCTL_MODE_CREATE_DUMB arguments: [
    //    fd: fd_dri (resource)
    //    cmd: const = 0xc02064d2 (4 bytes)
    //    arg: ptr[inout, drm_mode_create_dumb] {
    //      drm_mode_create_dumb {
    //        height: int32 = 0x1 (4 bytes)
    //        width: int32 = 0x80000000 (4 bytes)
    //        bpp: int32 = 0x0 (4 bytes)
    //        flags: const = 0x0 (4 bytes)
    //        handle: drm_dumb_handle (resource)
    //        pitch: int32 = 0x0 (4 bytes)
    //        size: int64 = 0x0 (8 bytes)
    ...
    //    }
    //  ]
    *(uint32_t*)0x200000000380 = 1;
    *(uint32_t*)0x200000000384 = 0x80000000;
    *(uint32_t*)0x200000000388 = 0;
    *(uint32_t*)0x20000000038c = 0;
    syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc02064d2,
  ...
  case 3:
    ...
    //  ]
    //  returns fd_dri
    syz_open_dev(/*dev=*/0, /*id=*/0, /*flags=O_LARGEFILE*/ 0x8000);
    break;
  case 4:
    //  ioctl$DRM_IOCTL_MODE_CREATE_DUMB arguments: [
    //    fd: fd_dri (resource)
    ...
    //    arg: nil
    //  ]
    syscall(__NR_ioctl, /*fd=*/(intptr_t)-1, /*cmd=*/0xc02064b2, /*arg=*/0ul);
    break;
  }
}
int main(void)
